...
var State_Admin = function($) {
  ...
  /**
   * Pass value of a form field to object list of all (relevant) form fields,
   * and update JSON object in aggregate form field.
   *
  ...
  /**
   * Unpack aggregate values, and set event handlers on all relevant
   * form fields.
   *
   * @return {void}
   */
  this.init = function() {
    ...
    // Make frontend session management checkbox control expand/collapse
    // of child fieldset.
    ...
    // Combine English message override fields into a single hidden textarea
